    ...
    const handleSubmit= async ()=>{
      ...
      if(emailregex.test(email) && usernameregex.test(username) && passowrdregex.test(password)){
        ...
        try {
          ...
          console.log("this is the user id", response.data.data.userId);
      ...
      <Card variant="outlined" className="signincard">
        ...
        <div className="errortext">
          ...
          <div>
            {invalidpassword && (
              <p className="warning">
                - Password must be at least 8 characters long,not exceed 20
                characters ,must contain at least one uppercase letter and at
          ...
          <div>
            {invalidusername && (
              <p className="warning">
                - Username should begin with a letter and should be 3 to 15
                characters long
              </p>
            )}
          </div>
